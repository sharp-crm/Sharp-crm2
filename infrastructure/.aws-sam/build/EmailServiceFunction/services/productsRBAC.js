...
exports.productsRBACService = exports.ProductsRBACService = void 0;
const lib_dynamodb_1 = require("@aws-sdk/lib-dynamodb");
const dynamoClient_1 = require("./dynamoClient");
class ProductsRBACService {
    constructor() {
     ...
     */
    async getProductByIdForUser(productId, user) {
     ...
     */
    async canUserAccessProduct(product, user) {
     ...
     */
    async canUserAccessProductsFromOwner(ownerId, user) {
        switch (user.role) {
            case 'ADMIN':
...
exports.ProductsRBACService = ProductsRBACService;
// Export singleton instance
exports.productsRBACService = new ProductsRBACService();
