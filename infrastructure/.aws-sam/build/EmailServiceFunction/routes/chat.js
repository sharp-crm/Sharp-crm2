...
router.get('/channels', async (req, res) => {
    try {
        ...
        const result = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand({
            TableName: dynamoClient_1.TABLES.CHANNELS,
...
router.get('/channels/:channelId/messages', async (req, res) => {
    try {
        ...
        const channelResult = await dynamoClient_1.docClient.send(new lib_dynamodb_1.GetCommand({
            TableName: dynamoClient_1.TABLES.CHANNELS,
        ...
        const messagesResult = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand({
            TableName: dynamoClient_1.TABLES.MESSAGES,
...
router.get('/direct-messages', async (req, res) => {
    try {
        ...
        const senderResult = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand({
            TableName: dynamoClient_1.TABLES.DIRECT_MESSAGES,
        ...
        const recipientResult = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand({
            TableName: dynamoClient_1.TABLES.DIRECT_MESSAGES,
...
router.post('/direct-messages/:messageId/read', async (req, res) => {
    try {
        ...
        const messageResult = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand({
            TableName: dynamoClient_1.TABLES.DIRECT_MESSAGES,
