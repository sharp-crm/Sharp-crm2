...
exports.contactsRBACService = exports.ContactsRBACService = void 0;
const lib_dynamodb_1 = require("@aws-sdk/lib-dynamodb");
const dynamoClient_1 = require("./dynamoClient");
class ContactsRBACService {
    constructor() {
    ...
    async getContactsForUser(user, includeDeleted = false) {
        ...
        try {
            ...
            const result = await dynamoClient_1.docClient.send(new lib_dynamodb_1.QueryCommand(baseQueryParams));
     ...
     */
    async getContactByIdForUser(contactId, user) {
     ...
     */
    async canUserAccessContact(contact, user) {
     ...
     */
    async canUserAccessContactsFromOwner(ownerId, user) {
        switch (user.role) {
            case 'ADMIN':
...
exports.ContactsRBACService = ContactsRBACService;
// Export singleton instance
exports.contactsRBACService = new ContactsRBACService();
